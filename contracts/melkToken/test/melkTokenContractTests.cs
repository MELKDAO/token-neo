...
namespace melkTokenTests
{
    [CheckpointPath("test/bin/checkpoints/contract-deployed.neoxp-checkpoint")]
    public class melkTokenContractTests : IClassFixture<CheckpointFixture<melkTokenContractTests>>
    {
        ...
        public melkTokenContractTests(CheckpointFixture<melkTokenContractTests> fixture)
        {
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<melkTokenContract>();
